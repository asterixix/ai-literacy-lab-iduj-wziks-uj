...
**Czym jest:** Wyszukiwarka zaprojektowana do odpowiadania na pytania w stylu _"czy X jest prawdą?"_ z syntezą wyników z badań naukowych. Używa GPT-4 do analizy 200M+ prac.
...
**Czym jest:** Narzędzie do automatyzacji _research workflow_ — szczególnie ekstrakcji danych z wielu artykułów do tabel. Indeksuje 138 milionów artykułów.
