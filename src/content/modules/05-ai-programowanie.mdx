...
Zamiast: _"Napisz pętlę for z filtrowaniem..."_
Użyj: _"Wczytaj plik CSV, usuń wiersze gdzie kolumna 'status' = 'nieaktywny', zapisz do nowego pliku CSV."_
...
Po każdym wygenerowanym kodzie dodaj: _"Wyjaśnij mi każdy krok co najważniejsze sekcje robią, jednym zdaniem każda."_
...
Badania (2024/2025) pokazują, że intensywne korzystanie z AI do pisania kodu może spowalniać naukę programowania. Zjawisko _cognitive offloading_ — przekazywania myślenia do zewnętrznego narzędzia — jest realne.
