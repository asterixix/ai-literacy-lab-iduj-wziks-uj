      ...
      <div className="container-wide space-y-6">
        <header className="space-y-2">
          ...
          <h2 className="text-3xl font-black tracking-tight md:text-4xl">
            Wykład gościnny — 14.05.2026
          </h2>
          <p className="max-w-3xl text-muted-foreground">
            Wykład odbędzie się w budynku WZiKS, aula 0.103, w godzinach 16:00-18:00.
          </p>
        </header>
        ...
        <article className="border border-border p-5">
          ...
          <div className="mt-3 grid gap-4 md:grid-cols-2">
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                <span className="font-semibold text-foreground">Pełny opis:</span> Omawiane są w
                sposób uproszczony podstawowe koncepcje różnych wariantów AI. W oparciu o tę wiedzę
                oraz przykłady przedstawione zostaną różne rodzaje zagrożeń związanych z
                wykorzystaniem AI. Analiza zagrożeń będzie rozszerzona o dobre praktyki
                zabezpieczające przed prezentowanymi ryzykami oraz o przykłady użycia AI do działań
